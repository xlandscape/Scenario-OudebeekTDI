...
base.documentation.document_scenario(
    os.path.join(root_folder, "..", "..", "scenario", "oudebeek-tdi", "scenario.xproject"),
    os.path.join(root_folder, "..", "..", "scenario", "oudebeek-tdi", "README.md")
)
base.documentation.write_scenario_changelog(
    os.path.join(root_folder, "..", "..", "scenario", "oudebeek-tdi", "scenario.xproject"),
    os.path.join(root_folder, "..", "..", "scenario", "oudebeek-tdi", "CHANGELOG.md")
)
base.documentation.write_contribution_notes(
    os.path.join(root_folder, "..", "..", "scenario", "oudebeek-tdi", "CONTRIBUTING.md"))
